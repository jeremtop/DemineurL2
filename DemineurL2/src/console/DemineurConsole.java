...
//				System.out.print(demineurModel.getMine(ligne, colonne) ? "O"
//						: "N");
				System.out.print(demineurModel.getCase(ligne, colonne).isClique() ? ""+demineurModel.getCase(ligne, colonne).isMine()
						: "N");
			}
